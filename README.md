...
> Landing Page is one of the many challenges you can find as part of the Responsive Web Design Certificate at FreeCodeCamp.org

**[Landing Page]** is one of the Capstone projects included in the Responsive Web Design Certificate at FreeCodeCamp.com. The objective is to build a product landing page to market the product of your choice.
...
- https://cuauh-cabrera.github.io/product-landing/
...
```sh
  cd my-folder
  git@github.com:cuauh-cabrera/product-landing.git
```
